...
const LineChartComponent = () => {
    ...
    const handleRoomsChanged = e => {
        ...
        if (e.target.value === '') {
            setRooms("Please enter rooms!");
        } else if (!/^[0-9]+$/.test(e.target.value)) {
            setRoomsError("Please enter a positive full number value for property count!");
        } else {
            setRoomsError(false);
        }
    }; 
    ...
    const handleCarsChanged = e => {
        ...
        if (e.target.value === '') {
            setCars("Please enter rooms!");
        } else if (!/^[0-9]+$/.test(e.target.value)) {
            setCarsError("Please enter a positive full number value for property count!");
        } else {
            setCarsError(false);
        }
    }; 
