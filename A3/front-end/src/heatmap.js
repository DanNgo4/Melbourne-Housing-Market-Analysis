...
const Heatmap = ({ geojsonData }) => {
  ...
  function getColor(price) {
    return price > 1000000 ? '#FF0000' : // Red for high prices
           price > 800000  ? '#FF7F00' : // Orange for medium-high prices
           price > 600000  ? '#FFFF00' : // Yellow for medium prices
           price > 400000  ? '#7FFF00' : // Light green for medium-low prices
           price > 200000  ? '#00FF00' : // Green for low prices
